var splitbee = function(e) {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                        case 0:
                            ...
                            e = B(), n = i(), s = document.referrer, l = 0 === s.indexOf(location.protocol + "//" + location.host) ? void 0 : s, r.label = 1;
                        case 1:
                            return r.trys.push([1, 4, , 5]), [4, fetch(D + a, {
                                method: "POST",
                                credentials: "include",
                                headers: t(t(t(t(t({
                                ...
                                body: JSON.stringify(t(t({}, c), l && !o && u && {
                                    referrer: l
                                }))
                            })];
                        case 2:
                        ...
                        case 3:
                            return v = r.sent(), h = f.headers.get("uid"), _(h), h && !I && q(h), [2, {
                                response: v || {},
                                statusCode: f.status
                            }];
                        case 4:
    ...
    var s = function() {
            u = !1, window.sbCtx = c(), n(void 0, void 0, void 0, (function() {
                return r(this, (function(e) {
                    switch (e.label) {
                        case 0:
                            return /[^0-9.,]404[^0-9.,]/.test(document.documentElement.innerHTML) ? [4, fetch(window.location.href, {
                                method: "head"
                            }).then((function(e) {
                                return e.status
                            })).catch((function() {}))] : [2, 0];
            ...
            u || function(e) {
                n(void 0, void 0, void 0, (function() {
                    return r(this, (function(n) {
                        try {
                            navigator && navigator.sendBeacon && !R && navigator.sendBeacon(D + "/end", JSON.stringify(t(t({}, e), {
                                headers: t({}, L && {
                                    sbp: L
                                })
                            })))
    ...
    var m, y = document.currentScript,
        g = y.dataset,
        k = g.token,
        E = g.splitbeeid,
        L = k || E,
    ...
    var R = "1" === M("splitbee-dnt"),
        ...
        q = function(e) {
            if (e) {
                ...
                document.cookie = U + "=" + e + ";path=/;SameSite=Lax;" + i + (A ? ";domain=" + r : "")
            }
        },
        B = function() {
        ...
        J = function(e, t, o) {
            "FORM" === e.tagName ? e.onsubmit = function(o) {
                ...
                return n(this, void 0, void 0, (function() {
                    return r(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                return "a" !== e.tagName.toLowerCase() ? [3, 4] : (i.preventDefault(), "_blank" === e.getAttribute("target") || i.metaKey ? (window.open(e.href, "_blank"), W(t, o), [3, 3]) : [3, 1]);
                            case 1:
                                return [4, W(t, o)];
                            case 2:
            ...
            return n(void 0, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                        ...
                        case 2:
                            return n = r.sent(), o = n.response, n.statusCode, o ? (o.actions && (G = o.actions), o.type, [3, 4]) : [2];
                        case 3:
                            return r.sent(), [3, 4];
                        case 4:
                            return F(G), [2]
        ...
        history.pushState = function() {
            ...
            [].slice.call(document.querySelectorAll("[data-splitbee-event]")).forEach((function(e) {
                if (!K.has(e)) {
                    ...
                    })) : t = void 0, K.set(e, !0), J(e, e.dataset.splitbeeEvent, t)
                }
            }))
        }), 500), window.splitbeeLoaded = !0
    }
    var Q = H,
        V = function(e) {
            q(e ? P() : m), I = !1, s()
        };
    return e.enableCookie = V, e.init = Q, e.reset = function() {
        N("_userId"), q(P()), s()
    }, e.track = W, e.user = $, e
}({});